...
function Officers() {
  ...
  const posts = [
    ...
    { id: 3, name: 'Diego', role: 'Current Treasurer', content: 'Diego is a low level programmer who also programs in haxe. He also works at a startup and contributes to open source.', linkedin: 'https://www.linkedin.com/in/diego-a-fonseca/', github: 'https://github.com/Just-Feeshy', img: diego, alt: 'Diego\'s picture' },
    {
