...
function Officers() {
  ...
  const posts = [
    ...
    { id: 3, name: 'Diego', role: 'Current Treasurer', content: 'Diego is a low level programmer who also programs in haxe. He also works at a startup and contributes to open source.', linkedin: 'https://www.linkedin.com/in/diego-a-fonseca/', github: '', img: diego, alt: 'Diego\'s picture' },
    {
    ...
    { id: 6, name: 'Aren', role: 'Former President', content: 'Aren has graduated NVCC and now goes to Virginia Tech where he is close to graduating. He is still active in the club through discord.', linkedin: '', github: '', img: '', alt: '' },
